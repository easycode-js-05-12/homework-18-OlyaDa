...
export class LoginComponent {
    ...
    /**
     * @desc Изменяет маршрут к текущей странице пользователя
     */
    async beforeRender() {
    ...
    /**
     * @desc Отображает разметку для формы входа пользователя
    ...
    /**
     * @desc Вызывает авторизацию логина при отправке
     */    
    afterRender() {
